...
export default function CartButton({ children, numberOfItems = 1, cartValue = "24,00" }) {
   return (
      <div className="flex w-3/4 max-w-md bg-secondary-orange h-11 cursor-pointer text-primary-bk font-medium items-center justify-around absolute bottom-3 rounded-md shadow-lg">
